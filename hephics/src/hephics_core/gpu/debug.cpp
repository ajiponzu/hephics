...
std::vector<const char*>
    hpxc::gpu::debug::Messenger::s_validationLayers = {
...
hpxc::gpu::debug::Messenger::~Messenger() { m_ptrMessenger.release(); }

vk::UniqueInstance hpxc::gpu::debug::Messenger::createDebugInstance(
  ...
  const vk::StructureChain<vk::InstanceCreateInfo, vk::ValidationFeaturesEXT,
                           vk::DebugUtilsMessengerCreateInfoEXT>
      create_info_chain(
          {{}, &app_info, s_validationLayers, extensions}, validation_features,
